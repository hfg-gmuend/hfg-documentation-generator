...
function createStructure() {
  ...
  filePaths.forEach(function (filePath) {
    // it seems filePath does not come with system specific path separators. It's always "/". At least on Mac and Windows...
    var parentName = path.dirname(filePath).split("/").pop();
