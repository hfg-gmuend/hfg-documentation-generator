 ...
 */
Kirby::plugin("fieldMethods/columnify", [
    "fieldMethods" => [
        "columnify" => function ($field) {
            ...
            if(strlen($field) > 0) {
                ...
                $columnifingElements = option("columnify.elements", []);
                ...
                foreach($doc->childNodes as $child) {
                    ...
                    if(is_a($child, "DOMElement")) {
                        ...
                        $childDefinition = [$child->nodeName];
                ...
                foreach($matches as $key => $match) {
                    ...
                    $container = $doc->createElement("div");
                        ...
                        if(isset($columnifingElements[$match["key"]]) && isset($columnifingElements[$match["key"]]["element_class"])) {
                            ...
                            $container->setAttribute("class", option("columnify.default")["element_class"]);
                        }
                    ...
                    if(isset($columnifingElements[$match["key"]]) && isset($columnifingElements[$match["key"]]["placeholder_classes"])) {
                        ...
                        $placeholderClasses = option("columnify.default")["placeholder_classes"];
                        $placeholderClasses = is_array($placeholderClasses) ? $placeholderClasses : [$placeholderClasses];
                    }
